...
discrepancies in the results. Explicitly mentionining that *"I did this using this function from that package version 1.2.3"* is a way of **protecting yourself** by being transparent about what you have found doing what you have
done.
...
> Statistical analysis were carried out using R 3.5.0 (R Core Team, 2018), the
