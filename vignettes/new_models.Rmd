...
Copy and paste the [**template file**](https://github.com/easystats/report/tree/master/R/report.default.R), and replace the function with the one you would like to see supported.
