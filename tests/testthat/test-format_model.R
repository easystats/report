...
test_that("format_model", {
  ...
  testthat::expect_equal(format_model(circus::download_model("glm_2")), "logistic model")
  testthat::expect_equal(format_model(circus::download_model("glm_3")), "logistic model")
  testthat::expect_equal(format_model(circus::download_model("glm_4")), "probit model")
  ...
  testthat::expect_equal(format_model(circus::download_model("merMod_2")), "logistic mixed model")
