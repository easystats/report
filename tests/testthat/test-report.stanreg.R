...
test_that("report.stanreg_glm", {
  r <- report(insight::download_model("stanreg_glm_1"), effsize = "cohen1988", standardize = "full")
...
test_that("report.stanreg_lmer", {
  r <- report(insight::download_model("stanreg_lmerMod_1"), effsize = "cohen1988", standardize = "full")
