...
test_that("report.stanreg_lm", {
  ...
  # r <- report(insight::download_model("stanreg_lm_1"), bootstrap = TRUE, n = 10)
  # testthat::expect_equal(r$values$parameters$wt$Median, -5.34, tol = 0.2)
  #
  # r <- report(insight::download_model("stanreg_lm_1"), effsize = "cohen1988", standardize = TRUE, parameters_estimate = "Mean")
  # testthat::expect_equal(r$values$parameters$wt$Mean, -5.3397, tol = 0.2)
  #
  # r <- report(insight::download_model("stanreg_lm_1"), effsize = "cohen1988", standardize = TRUE, parameters_estimate = "MAP")
  # testthat::expect_equal(r$values$parameters$wt$MAP, -5.22, tol = 0.2)
  #
  # r <- report(insight::download_model("stanreg_lm_1"), effsize = "cohen1988", rope_full=FALSE, standardize = TRUE, parameters_estimate = c("Mean", "Median", "MAP"))
  ...
  #
  # testthat::expect_warning(report(insight::download_model("stanreg_lm_3"), standardize = FALSE, effsize="cohen1988"))
})
#
#
...
#   r <- report(insight::download_model("stanreg_glm_1"), effsize = "cohen1988", standardize = TRUE)
...
#   r <- report(insight::download_model("stanreg_lmerMod_1"), effsize = "cohen1988", standardize = TRUE)
#   testthat::expect_equal(r$values$parameters$cyl$Median, 0.406, tol = 0.2)
#   testthat::expect_equal(ncol(to_table(r)), 8)
#
#   r <- report(insight::download_model("stanreg_merMod_1"), effsize = "chen2010", standardize = TRUE)
