# model-stanreg detailed
    ...
    Output
      ...
      assumptions were checked: no influential observations were detected, the error
      variance appeared homoskedastic (p = 0.423) and no collinearity was detected.
      The model's explanatory power is substantial (R2 = 0.81, 95% CI [0.70, 0.90],
      adj. R2 =
      ...
      successfuly converged (Rhat = 1.013)
