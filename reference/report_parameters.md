...
#>   - R (version 4.6.0; R Core Team, 2026)
...
report_parameters(model)
#>   - The intercept (Median = 5.01, 95% CI [4.88, 5.14]) has a 100.00% probability of being positive (> 0), 100.00% of being significant (> 0.04), and 100.00% of being large (> 0.25). The estimation successfully converged (Rhat = 1.000) but the indices are unreliable (ESS = 793)
#>   - The effect of Species [versicolor] (Median = 0.93, 95% CI [0.74, 1.11]) has a 100.00% probability of being positive (> 0), 100.00% of being significant (> 0.04), and 100.00% of being large (> 0.25). The estimation successfully converged (Rhat = 1.000) but the indices are unreliable (ESS = 745)
#>   - The effect of Species [virginica] (Median = 1.58, 95% CI [1.38, 1.79]) has a 100.00% probability of being positive (> 0), 100.00% of being significant (> 0.04), and 100.00% of being large (> 0.25). The estimation successfully converged (Rhat = 1.003) but the indices are unreliable (ESS = 843)
# }
```
