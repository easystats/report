...
r <- report(session)
r
#> Analyses were conducted using the R Statistical language (version 4.6.0; R Core
#> Team, 2026) on Ubuntu 24.04.4 LTS, using the packages Matrix (version 1.7.5;
#> Bates D et al., 2026), lme4 (version 2.0.1; Bates D et al., 2015), brms
...
#> (version 0.17.0; Makowski D et al., 2019), modelbased (version 0.15.0; Makowski
#> D et al., 2025), report (version 0.6.4; Makowski D et al., 2023), BayesFactor
...
#> References
#> ----------
#>   - Bates D, Maechler M, Jagan M (2026). _Matrix: Sparse and Dense Matrix Classes
#> and Methods_. doi:10.32614/CRAN.package.Matrix
#> <https://doi.org/10.32614/CRAN.package.Matrix>. R package version 1.7-5,
...
#> version 1.1.1-1.1, <https://www.rcpp.org>. Eddelbuettel D, François R (2011).
...
#> modelbased (v0.15.0), report (v0.6.4), BayesFactor (v0.9.12.4.8), coda
#> (v0.19.4.1), lavaan (v0.6.21) and dplyr (v1.2.1).
as.data.frame(r)
#> Package     |    Version |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Reference
#> ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#> BayesFactor | 0.9.12.4.8 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               Morey R, Rouder J (2026). _BayesFactor: Computation of Bayes Factors for Common Designs_. R package version 0.9.12-4.8, <https://richarddmorey.github.io/BayesFactor/>.
#> Matrix      |      1.7.5 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Bates D, Maechler M, Jagan M (2026). _Matrix: Sparse and Dense Matrix Classes and Methods_. doi:10.32614/CRAN.package.Matrix <https://doi.org/10.32614/CRAN.package.Matrix>. R package version 1.7-5, <https://CRAN.R-project.org/package=Matrix>.
#> R           |      4.6.0 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    R Core Team (2026). _R: A Language and Environment for Statistical Computing_. R Foundation for Statistical Computing, Vienna, Austria. doi:10.32614/R.manuals <https://doi.org/10.32614/R.manuals>. <https://www.R-project.org/>.
#> Rcpp        |  1.1.1.1.1 | Eddelbuettel D, Francois R, Allaire J, Ushey K, Kou Q, Russell N, Ucar I, Bates D, Chambers J (2026). _Rcpp: Seamless R and C++ Integration_. R package version 1.1.1-1.1, <https://www.rcpp.org>. Eddelbuettel D, François R (2011). “Rcpp: Seamless R and C++ Integration.” _Journal of Statistical Software_, *40*(8), 1-18. doi:10.18637/jss.v040.i08 <https://doi.org/10.18637/jss.v040.i08>. Eddelbuettel D (2013). _Seamless R and C++ Integration with Rcpp_. Springer, New York. doi:10.1007/978-1-4614-6868-4 <https://doi.org/10.1007/978-1-4614-6868-4>. ISBN 978-1-4614-6867-7. Eddelbuettel D, Balamuta J (2018). “Extending R with C++: A Brief Introduction to Rcpp.” _The American Statistician_, *72*(1), 28-36. doi:10.1080/00031305.2017.1375990 <https://doi.org/10.1080/00031305.2017.1375990>.
...
#> dplyr       |      1.2.1 |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Wickham H, François R, Henry L, Müller K, Vaughan D (2026). _dplyr: A Grammar of Data Manipulation_. R package version 1.2.1, <https://dplyr.tidyverse.org>.
...
#>   - Matrix (version 1.7.5; Bates D et al., 2026)
#>   - lme4 (version 2.0.1; Bates D et al., 2015)
#>   - brms (version 2.23.0; Bürkner P, 2017)
#>   - Rcpp (version 1.1.1.1.1; Eddelbuettel D et al., 2026)
#>   - performance (version 0.16.0; Lüdecke D et al., 2021)
#>   - bayestestR (version 0.17.0; Makowski D et al., 2019)
#>   - modelbased (version 0.15.0; Makowski D et al., 2025)
#>   - report (version 0.6.4; Makowski D et al., 2023)
...
#> > Bates D, Maechler M, Jagan M (2026). _Matrix: Sparse and Dense Matrix Classes and Methods_. doi:10.32614/CRAN.package.Matrix <https://doi.org/10.32614/CRAN.package.Matrix>. R package version 1.7-5, <https://CRAN.R-project.org/package=Matrix>.
...
#> > Eddelbuettel D, Francois R, Allaire J, Ushey K, Kou Q, Russell N, Ucar I, Bates D, Chambers J (2026). _Rcpp: Seamless R and C++ Integration_. R package version 1.1.1-1.1, <https://www.rcpp.org>. Eddelbuettel D, François R (2011). “Rcpp: Seamless R and C++ Integration.” _Journal of Statistical Software_, *40*(8), 1-18. doi:10.18637/jss.v040.i08 <https://doi.org/10.18637/jss.v040.i08>. Eddelbuettel D (2013). _Seamless R and C++ Integration with Rcpp_. Springer, New York. doi:10.1007/978-1-4614-6868-4 <https://doi.org/10.1007/978-1-4614-6868-4>. ISBN 978-1-4614-6867-7. Eddelbuettel D, Balamuta J (2018). “Extending R with C++: A Brief Introduction to Rcpp.” _The American Statistician_, *72*(1), 28-36. doi:10.1080/00031305.2017.1375990 <https://doi.org/10.1080/00031305.2017.1375990>.
...
#> > Morey R, Rouder J (2026). _BayesFactor: Computation of Bayes Factors for Common Designs_. R package version 0.9.12-4.8, <https://richarddmorey.github.io/BayesFactor/>.
...
#> > Wickham H, François R, Henry L, Müller K, Vaughan D (2026). _dplyr: A Grammar of Data Manipulation_. R package version 1.2.1, <https://dplyr.tidyverse.org>.
report_system()
#> Analyses were conducted using the R Statistical language (version 4.6.0; R Core
#> Team, 2026) on Ubuntu 24.04.4 LTS
```
