...
#> 2025), performance (version 0.15.3; Lüdecke D et al., 2021), bayestestR
#> (version 0.17.0; Makowski D et al., 2019), modelbased (version 0.13.1; Makowski
#> D et al., 2025), report (version 0.6.2.1; Makowski D et al., 2023), BayesFactor
...
#> (v1.1.38), brms (v2.23.0), Rcpp (v1.1.0), performance (v0.15.3), bayestestR
#> (v0.17.0), modelbased (v0.13.1), report (v0.6.2.1), BayesFactor (v0.9.12.4.7),
#> coda (v0.19.4.1), lavaan (v0.6.21) and dplyr (v1.1.4).
as.data.frame(r)
...
#>   - report (version 0.6.2.1; Makowski D et al., 2023)
