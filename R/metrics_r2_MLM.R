...
#' @references
#' \itemize{
#'   \item Rights & Sterba (2018). Quantifying explained variance in multilevel models: An integrative framework for defining R-squared measures. Psychological Methods.
#'   \item Rights & Cole (2018) Effect Size Measures for Multilevel Models in Clinical Child and Adolescent Research: New R-Squared Methods and Recommendations, Journal of Clinical Child & Adolescent Psychology, 47:6.
#' }
index_r2_MLM <- function(data, Tau, sigma2, within_covs = NULL, between_covs = NULL, random_covs = NULL, gamma_w = NULL, gamma_b = NULL, has_intercept = TRUE, clustermeancentered = TRUE) {
