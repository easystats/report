...
> **Tip**
>
> **Instead of [`library(report)`](https://easystats.github.io/report/),
...
[![All the things meme by Allie
Brosh](reference/figures/allthethings.jpg)](https://easystats.github.io/report/)
...
report using [`summary()`](https://rdrr.io/r/base/summary.html) on the
report object.

[![workflow](reference/figures/workflow.png)](https://easystats.github.io/report/)

The [`report()`](https://easystats.github.io/report/reference/report.md)
function works on a variety of models, as well as other objects such as
dataframes:
